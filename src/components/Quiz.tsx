...
const Quiz = ({chapter}: Props) => {
    ...
    const checkAnswer = React.useCallback(() => {
        ...
        chapter.questions.forEach((question) => {
          const user_answer = ans[question.id];
      ...
      }, [ans, questionState, chapter.questions]);
    return (
    <div className='flex-[1]'>
        ...
        <div className='mt-2'>
            {chapter.questions.map((question)=>{
                ...
                return(
                    <div key={question.id} className={cn('p-3 mt-4 border border-secondary rounded-md',
